package course.QExpress.dispatch.job;
...
import course.QExpress.dispatch.mq.TransportOrderDispatchMQListener;
...
public class DispatchJob {
    ...
    public void transportTask() {
        ...
        List<TruckPlanDto> truckDtoList = truckPlanFeign.pullUnassignedPlan(shardTotal, shardIndex);
        ...
        for (TruckPlanDto truckPlanDto : truckDtoList) {
            ...
            if (ObjectUtil.hasEmpty(truckPlanDto.getId(), truckPlanDto.getStartOrganId(), truckPlanDto.getEndOrganId(), truckPlanDto.getTransportTripsId())) {
