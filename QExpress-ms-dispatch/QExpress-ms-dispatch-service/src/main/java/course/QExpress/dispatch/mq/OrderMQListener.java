...
import course.QExpress.courier.api.CourierFeign;
...
public class OrderMQListener {
    ...
    private Long selectCourier(List<Long> courierIds, Integer taskType) {
        ...
        // 4. 查看返回任务数是否与快递员数量相同
        if (ObjectUtil.notEqual(CollUtil.size(courierTaskCountDTOS), CollUtil.size(courierIds))) {
