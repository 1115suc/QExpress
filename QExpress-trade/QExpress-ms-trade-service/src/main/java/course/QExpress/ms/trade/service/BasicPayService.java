...
public interface BasicPayService {
     ...
     * @return 交易数据对象
     */
    TradingDTO queryTrading(Long tradingOrderNo) throws QEException;
     ...
     * @return 是否成功
     */
    Boolean refundTrading(Long tradingOrderNo, BigDecimal refundAmount) throws QEException;
     ...
     * @return 退款记录数据
     */
    RefundRecordDTO queryRefundTrading(Long refundNo) throws QEException;
