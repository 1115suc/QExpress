...
public class AliNativePayHandler implements NativePayHandler {
    ...
    public void createDownLineTrading(TradingEntity tradingEntity) throws QEException {
        ...
        try {
            ...
            throw new QEException(TradingEnum.NATIVE_PAY_FAIL, e);
        }
        ...
        throw new QEException(JSONUtil.toJsonStr(response), TradingEnum.NATIVE_PAY_FAIL.getCode(), TradingEnum.NATIVE_PAY_FAIL.getStatus());
    }
