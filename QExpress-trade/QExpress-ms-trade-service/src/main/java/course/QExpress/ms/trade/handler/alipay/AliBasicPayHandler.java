...
public class AliBasicPayHandler implements BasicPayHandler {
    ...
    public Boolean queryTrading(TradingEntity trading) throws QEException {
        ...
        try {
            ...
            log.error(msg, e);
            throw new QEException(msg, TradingEnum.NATIVE_QUERY_FAIL.getCode(), TradingEnum.NATIVE_QUERY_FAIL.getStatus());
        }
        ...
        throw new QEException(trading.getResultJson(), TradingEnum.NATIVE_QUERY_FAIL.getCode(), TradingEnum.NATIVE_QUERY_FAIL.getStatus());
    }
    ...
    public Boolean closeTrading(TradingEntity trading) throws QEException {
        ...
        try {
            ...
            throw new QEException(TradingEnum.CLOSE_FAIL, e);
        }
    }
    ...
    public Boolean refundTrading(RefundRecordEntity refundRecord) throws QEException {
        ...
        try {
            ...
            log.error(msg, e);
            throw new QEException(msg, TradingEnum.NATIVE_REFUND_FAIL.getCode(), TradingEnum.NATIVE_REFUND_FAIL.getStatus());
        }
        ...
        throw new QEException(refundRecord.getRefundMsg(), TradingEnum.NATIVE_REFUND_FAIL.getCode(), TradingEnum.NATIVE_REFUND_FAIL.getStatus());
    }
    ...
    public Boolean queryRefundTrading(RefundRecordEntity refundRecord) throws QEException {
        ...
        try {
            ...
            throw new QEException(TradingEnum.NATIVE_REFUND_FAIL, e);
        }
