...
import course.QExpress.ms.trade.domain.PayChannelDTO;
...
public class PayChannelController {
    ...
    public void createPayChannel(@RequestBody PayChannelDTO payChannelDTO) {
        ...
        throw new QEException("添加支付通道失败", HttpStatus.INTERNAL_SERVER_ERROR.value());
    }
    ...
    public void updatePayChannel(@RequestBody PayChannelDTO payChannelDTO) {
        ...
        throw new QEException("修改支付通道失败", HttpStatus.INTERNAL_SERVER_ERROR.value());
    }
    ...
    public void deletePayChannel(@RequestBody PayChannelDTO payChannelDTO) {
        ...
        throw new QEException("删除支付通道失败", HttpStatus.INTERNAL_SERVER_ERROR.value());
    }
    ...
    public void updatePayChannelEnableFlag(@RequestBody PayChannelDTO payChannelDTO) {
        ...
        throw new QEException("修改支付通道状态失败", HttpStatus.INTERNAL_SERVER_ERROR.value());
    }
}
