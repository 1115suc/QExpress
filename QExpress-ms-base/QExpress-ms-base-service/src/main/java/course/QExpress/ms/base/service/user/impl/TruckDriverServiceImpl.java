package course.QExpress.ms.base.service.user.impl;
...
import course.QExpress.ms.base.mapper.user.TruckDriverMapper;
...
public class TruckDriverServiceImpl extends ServiceImpl<TruckDriverMapper, TruckDriverEntity>
    ...
    private final TransportTripsTruckDriverService transportTripsTruckDriverService;
    ...
    private void checkCanBingingTruck(TruckDriverEntity oldDriver) {
        ...
        if (ObjectUtil.isNotEmpty(oldDriver.getTruckId())) {
            ...
            if (all.size() > 0) {
                ...
                throw new QEException(StrUtil.format("请先解除原有车辆对应的车次绑定关系 详细: 线路名称 {} 车次名称{}", names, tripsNames));
            }
        }
    }
