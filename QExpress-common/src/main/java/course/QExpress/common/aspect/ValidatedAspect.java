package course.QExpress.common.aspect;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.json.JSONUtil;
import course.QExpress.common.exception.QEException;
import course.QExpress.common.util.AspectUtil;
...
public class ValidatedAspect {
    ...
    @Around("execution(* course.QExpress..controller.*Controller.*(..))")
    public Object around(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        if (!ObjectUtil.isEmpty(body)) {
            ...
            if (CollUtil.isNotEmpty(validateResult)) {
                ...
                throw new QEException(info, HttpStatus.BAD_REQUEST.value());
            }
        }
        //校验通过，执行原方法
