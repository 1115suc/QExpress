...
public class GlobalExceptionHandler {
     ...
     * @return 响应数据
     */
    @ExceptionHandler(QEException.class)
    public ResponseEntity<Object> handle(QEException exception) {
        if (ObjectUtil.isNotEmpty(exception.getCause())) {
     ...
     * @return 响应数据
     */
    @ExceptionHandler(QEWebException.class)
    public ResponseEntity<Object> handle(QEWebException exception) {
        if (ObjectUtil.isNotEmpty(exception.getCause())) {
            log.error("自定义异常处理 -> ", exception);
        }
