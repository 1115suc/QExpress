package course.QExpress.work.api;
...
@FeignClient(name = "QExpress-ms-work", contextId = "TransportTask", path = "transport-task")
public interface TransportTaskFeign {
    ...
    @ApiOperation(value = "根据车辆ID统计", notes = "根据车辆ID统计")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "truckId", value = "车辆ID", dataTypeClass = Long.class)
    })
