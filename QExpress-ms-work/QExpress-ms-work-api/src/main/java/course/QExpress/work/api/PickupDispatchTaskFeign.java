...
import course.QExpress.work.domain.enums.pickupDispatchtask.PickupDispatchTaskIsDeleted;
...
@FeignClient(value = "QExpress-ms-work", contextId = "pickup-dispatch", path = "pickup-dispatch-task")
