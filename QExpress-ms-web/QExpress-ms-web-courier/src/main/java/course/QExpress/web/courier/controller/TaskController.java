...
public class TaskController {
    ...
    public R<PageResponse<TaskVO>> pageQuery(@Valid TaskQueryVO vo) {
        PageResponse<TaskVO> voList = taskService.pageQuery(vo);
        return R.success(voList);
    }

    @ApiOperation("取消任务")
    @PostMapping("/cancel")
    public R<Void> cancel(@Valid @RequestBody TasksCancelVO tasksCancelVO) {
    ...
    public R<RealNameVerifyVO> idCardCheck(@Valid @RequestBody TaskIdCardCheckVO taskIdCardCheckVO) {
    ...
    @ApiOperation("取件")
    @PutMapping("/pickup")
    public R<Void> pickup(@Valid @RequestBody TaskPickupVO taskPickupVO) {
    ...
    @ApiOperation("签收")
    @PutMapping("sign")
    public R<Void> sign(@Valid @RequestBody TaskSignVO taskSignVO) {
    ...
    @ApiOperation("运单费用计算")
    public R<CarriageVO> calculate(@Valid @RequestBody CarriageCalculateVO carriageCalculateVO) {
