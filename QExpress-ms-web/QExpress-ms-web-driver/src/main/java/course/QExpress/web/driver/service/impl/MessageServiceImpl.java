...
import course.QExpress.web.driver.service.MessageService;
import course.QExpress.web.driver.vo.response.MessageVO;
...
public class MessageServiceImpl implements MessageService {
    ...
    public PageResponse<MessageVO> page(Integer contentType, Integer page, Integer pageSize) {
        ...
        //dto转为vo
        List<MessageVO> list = BeanUtil.copyToList(pageResponse.getItems(), MessageVO.class);
