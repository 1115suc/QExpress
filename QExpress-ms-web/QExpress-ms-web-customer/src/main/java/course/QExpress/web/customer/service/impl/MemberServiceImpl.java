...
import course.QExpress.common.util.RealNameVerifyUtil;
...
import course.QExpress.web.customer.properties.JwtProperties;
import course.QExpress.web.customer.service.MemberService;
import course.QExpress.web.customer.service.WechatService;
import course.QExpress.web.customer.util.JwtUtil;
import course.QExpress.web.customer.vo.user.MemberVO;
import course.QExpress.web.customer.vo.user.RealNameVerifyVO;
import course.QExpress.web.customer.vo.user.UserLoginRequestVO;
import course.QExpress.web.customer.vo.user.UserLoginVO;
...
public class MemberServiceImpl implements MemberService {
    ...
    public UserLoginVO login(UserLoginRequestVO userLoginRequestVO) throws IOException {
        ...
        if (ObjectUtil.isNotEmpty(jsonObject.getInt("errcode"))) {
            throw new QEWebException(jsonObject.getStr("errmsg"));
        }
