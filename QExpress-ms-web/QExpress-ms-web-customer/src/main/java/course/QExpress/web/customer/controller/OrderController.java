package course.QExpress.web.customer.controller;
...
public class OrderController {
    ...
    @ApiOperation("修改订单")
    @PutMapping("/{id}")
    public R update(@PathVariable("id") Long id, @RequestBody OrderVO vo) {
    ...
    @ApiOperation("支付")
    @PutMapping("/pay")
    public R pay(@RequestBody TradeLaunchVO tradeLaunchVO) {
