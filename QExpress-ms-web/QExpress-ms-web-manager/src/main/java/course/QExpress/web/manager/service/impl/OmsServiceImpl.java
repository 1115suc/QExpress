...
import course.QExpress.ms.base.domain.base.GoodsTypeDto;
...
import course.QExpress.web.manager.service.OmsService;
import course.QExpress.web.manager.service.WorkService;
import course.QExpress.web.manager.vo.baseCommon.GoodsTypeVO;
import course.QExpress.web.manager.vo.oms.OrderCargoUpdateVO;
import course.QExpress.web.manager.vo.oms.OrderCargoVO;
import course.QExpress.web.manager.vo.oms.OrderQueryVO;
import course.QExpress.web.manager.vo.oms.OrderVO;
import course.QExpress.web.manager.vo.work.TransportOrderPointVO;
...
public class OmsServiceImpl implements OmsService {
    ...
    public PageResponse<OrderVO> findByPage(OrderQueryVO vo) {
        ...
        List<OrderVO> orderVOList = batchParseOrderDTO2Vo(orderDTOList);
    ...
    public List<OrderVO> batchParseOrderDTO2Vo(List<OrderDTO> orderDTOList) {
        ...
        List<AreaDto> areaDtoList = areaFeign.findAll(null, new ArrayList<>(areaIdSet));
