...
import course.QExpress.web.manager.vo.work.PointVO;
import course.QExpress.web.manager.vo.work.TaskTransportQueryVO;
import course.QExpress.web.manager.vo.work.TaskTransportUpdateVO;
import course.QExpress.web.manager.vo.work.TaskTransportVO;
...
public class TransportTaskController {
    ...
    public R<PageResponse<TaskTransportVO>> findByPage(@RequestBody TaskTransportQueryVO vo) {
        PageResponse<TaskTransportVO> taskByPage = workService.findTaskByPage(vo);
        return R.success(taskByPage);
    }
    ...
    public R<TaskTransportVO> findById(@PathVariable(name = "id") Long id) {
        TaskTransportVO taskById = workService.findTaskById(id);
        return R.success(taskById);
    }
    ...
    public R<LinkedHashSet<PointVO>> findPointById(@PathVariable(name = "id") Long id) {
        LinkedHashSet<PointVO> taskPointById = workService.findTaskPointById(id);
        return R.success(taskPointById);
    }
    ...
    public R<Map<Integer, Long>> count() {
        Map<Integer, Long> count = workService.countTask();
