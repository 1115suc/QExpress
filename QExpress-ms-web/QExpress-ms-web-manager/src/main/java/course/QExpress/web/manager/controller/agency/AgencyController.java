package course.QExpress.web.manager.controller.agency;

import course.QExpress.common.util.PageResponse;
import course.QExpress.common.vo.R;
import course.QExpress.web.manager.service.AgencyService;
import course.QExpress.web.manager.service.AuthService;
import course.QExpress.web.manager.vo.agency.AgencyUpdateVO;
import course.QExpress.web.manager.vo.agency.AgencyVO;
import course.QExpress.web.manager.vo.agency.ServiceScopeVO;
import course.QExpress.web.manager.vo.auth.CourierVO;
...
public class AgencyController {
    ...
    public R<String> treeAgency() {
        String allTree = agencyService.treeAgency();
        return R.success(allTree);
    }
    ...
    public R<AgencyVO> findAgencyById(@PathVariable(name = "id") Long id) {
        AgencyVO agencyVO = agencyService.agencyDetail(id);
        return R.success(agencyVO);
    }
    ...
    public R<PageResponse<SysUserVO>> findUserByPage(@RequestParam(name = "page") Integer page,
        ...
        PageResponse<SysUserVO> userByPage = authService.findUserByPage(page, pageSize, agencyId, account, name, phone);
        return R.success(userByPage);
    }
    ...
    public R<PageResponse<SysUserVO>> findCourierByPage(@RequestParam(name = "page") Integer page,
                                                        ...
                                                        @RequestParam(name = "phone", required = false) String phone) {
        PageResponse<SysUserVO> courierByPage = authService.findCourierByPage(page, pageSize, name, phone, account, agentId);
        return R.success(courierByPage);
    }
    ...
    public R<SysUserVO> findCourierById(@PathVariable(name = "id") String id) {
        SysUserVO user = authService.user(Long.valueOf(id));
        return R.success(user);
    }
    ...
    public R deleteScopeById(@PathVariable(name = "id") Long id, @PathVariable(name = "type") Integer type) {
    ...
    @PostMapping("/scope")
    public R saveScope(@RequestBody ServiceScopeVO vo) {
    ...
    public R<ServiceScopeVO> findScope(@PathVariable(name = "id") Long id, @PathVariable(name = "type") Integer type) {
        ServiceScopeVO scope = agencyService.findScope(id, type);
        return R.success(scope);
    }
