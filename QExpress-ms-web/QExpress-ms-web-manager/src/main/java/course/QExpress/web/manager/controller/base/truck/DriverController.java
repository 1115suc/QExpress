...
import course.QExpress.web.manager.vo.baseTruck.BindingDriversVO;
import course.QExpress.web.manager.vo.baseTruck.DriverLicenseVO;
import course.QExpress.web.manager.vo.baseTruck.DriverUpdateVO;
import course.QExpress.web.manager.vo.baseTruck.DriverVO;
...
public class DriverController {
    ...
    public R<PageResponse<DriverVO>> findDriverByPage(@RequestParam(name = "page") Integer page,
        ...
        PageResponse<DriverVO> driverByPage = baseTruckService.findDriverByPage(page, pageSize, name, account, workStatus, agentId, phone);
        return R.success(driverByPage);
    }
    ...
    public R<DriverVO> findDriverById(@PathVariable(name = "id") Long id) {
        DriverVO driverById = baseTruckService.findDriverById(id);
        return R.success(driverById);
    }
