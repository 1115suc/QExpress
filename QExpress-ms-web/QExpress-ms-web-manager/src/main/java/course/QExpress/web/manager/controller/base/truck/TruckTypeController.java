...
public class TruckTypeController {
    ...
    public R<List<TruckTypeVO>> truckTypeSimple() {
        List<TruckTypeVO> truckTypeVOS = baseCommonService.truckTypeSimple();
        return R.success(truckTypeVOS);
    ...
    public R<PageResponse<TruckTypeVO>> findTruckTypeByPage(@RequestParam(name = "page") Integer page,
        ...
        PageResponse<TruckTypeVO> truckTypeByPage = baseCommonService.findTruckTypeByPage(page, pageSize, name, allowableLoad, allowableVolume, id);
        return R.success(truckTypeByPage);
    }
    ...
    public R<TruckTypeVO> findTruckTypeById(@PathVariable(name = "id") Long id) {
        TruckTypeVO truckTypeById = baseCommonService.findTruckTypeById(id);
        return R.success(truckTypeById);
    }
    ...
    public R deleteTruckType(@PathVariable(name = "id") Long id) {
