...
import course.QExpress.web.manager.service.TruckReturnRegisterService;
    ...
    private List<TruckReturnRegisterListVO> convertListDto2ListVo(List<TruckReturnRegisterListDTO> dtoList) {
        return dtoList.stream().map(dto -> {
            ...
            try {
                ...
                throw new QEWebException("id为" + truckReturnRegisterListVO.getTransportTaskId() + "的运输任务查询失败！");
            }
