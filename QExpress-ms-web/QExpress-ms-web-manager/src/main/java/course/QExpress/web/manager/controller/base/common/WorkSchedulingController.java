package course.QExpress.web.manager.controller.base.common;
...
import course.QExpress.web.manager.util.ImportVOListener;
import course.QExpress.web.manager.vo.baseCommon.WorkSchedulingAddVO;
import course.QExpress.web.manager.vo.baseCommon.WorkSchedulingExportVO;
import course.QExpress.web.manager.vo.baseCommon.WorkSchedulingVO;
...
public class WorkSchedulingController {
    ...
    public R delete(@PathVariable("id") Long id, @PathVariable("operator") Long operator) {
    ...
    @ApiOperation("人工调整")
    @PutMapping("")
    public R update(@RequestBody WorkSchedulingVO workSchedulingVO) {
    ...
    @ApiOperation("批量关联排班")
    @PostMapping("")
    public R batchSaveWorkScheduling(@RequestBody WorkSchedulingAddVO workSchedulingAddVO) {
