...
import course.QExpress.transport.utils.OrganServiceFactory;
import course.QExpress.transport.utils.OrganUtils;
...
public class OrganController {
    ...
    public void update(@RequestBody OrganDTO organDTO) {
        ...
        if (null == entityData) {
            throw new QEException("更新机构失败！", HttpStatus.INTERNAL_SERVER_ERROR.value());
        }
    }
