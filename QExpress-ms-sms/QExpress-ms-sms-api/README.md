# QExpress-ms-sms-api使用手册

## 1、说明

为了将短信相关的代码进行统一，所以将发送短信的代码抽取到QExpress-ms-sms-service中，而QExpress-ms-sms-api提供了短信服务的功能。
...
~~~xml
<dependency>
    <groupId>course.QExpress</groupId>
    <artifactId>QExpress-ms-sms-api</artifactId>
