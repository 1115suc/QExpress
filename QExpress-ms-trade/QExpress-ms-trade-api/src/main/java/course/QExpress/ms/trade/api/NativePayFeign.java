...
import course.QExpress.ms.trade.api.fallback.NativePayFeignFallbackFactory;
...
@FeignClient(value = "QExpress-ms-trade", contextId = "NativePay", path = "native", fallbackFactory = NativePayFeignFallbackFactory.class)
