...
public interface BasicPayHandler {
     ...
     * @return 是否有变化
     */
    Boolean queryTrading(TradingEntity trading) throws QEException;

    /***
     * 关闭交易
     * @return 是否成功
     */
    Boolean closeTrading(TradingEntity trading) throws QEException;
     ...
     * @return 是否有变化
     */
    Boolean refundTrading(RefundRecordEntity refundRecord) throws QEException;
     ...
     * @return 是否有变化
     */
    Boolean queryRefundTrading(RefundRecordEntity refundRecord) throws QEException;
