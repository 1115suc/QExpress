...
import static course.QExpress.ms.trade.enums.TradingEnum.CLOSE_FAIL;
import static course.QExpress.ms.trade.enums.TradingEnum.NATIVE_QUERY_REFUND_FAIL;
import static course.QExpress.ms.trade.enums.TradingEnum.NATIVE_REFUND_FAIL;
...
public class WeChatBasicPayHandler implements BasicPayHandler {
    ...
    @Override
    public Boolean queryTrading(TradingEntity trading) throws QEException {
        // 获取微信支付的client对象
        ...
        try {
            ...
            throw new QEException(NATIVE_REFUND_FAIL, e);
        }
        if (response.isOk()) {
        ...
        throw new QEException(response.getBody(), NATIVE_REFUND_FAIL.getCode(), NATIVE_REFUND_FAIL.getCode());
    }

    @Override
    public Boolean closeTrading(TradingEntity trading) throws QEException {
        // 获取微信支付的client对象
        WechatPayHttpClient client = WechatPayHttpClient.get(trading.getEnterpriseId());
        //请求地址
        ...
        try {
            ...
            throw new QEException(CLOSE_FAIL, e);
        }
    }

    @Override
    public Boolean refundTrading(RefundRecordEntity refundRecord) throws QEException {
        // 获取微信支付的client对象
        ...
        throw new QEException(refundRecord.getRefundMsg(), NATIVE_REFUND_FAIL.getCode(), NATIVE_REFUND_FAIL.getStatus());
    }

    @Override
    public Boolean queryRefundTrading(RefundRecordEntity refundRecord) throws QEException {
        // 获取微信支付的client对象
        WechatPayHttpClient client = WechatPayHttpClient.get(refundRecord.getEnterpriseId());
        ...
        try {
            ...
            throw new QEException(NATIVE_QUERY_REFUND_FAIL, e);
        }
        ...
        throw new QEException(response.getBody(), NATIVE_QUERY_REFUND_FAIL.getCode(), NATIVE_QUERY_REFUND_FAIL.getStatus());
    }
}
